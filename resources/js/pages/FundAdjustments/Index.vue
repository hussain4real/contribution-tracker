...
import { index, store } from '@/actions/App/Http/Controllers/FundAdjustmentController';
        ...
        <div class="flex h-full flex-1 flex-col gap-6 p-4 md:p-6">
            ...
            <div class="rounded-xl border border-blue-200 bg-blue-50 p-4 dark:border-blue-800 dark:bg-blue-900/20">
                <p class="text-sm text-blue-800 dark:text-blue-200">
                    Fund adjustments represent lump sums added to the family fund (e.g., opening balance from previous contributions).
                </p>
            </div>

            <!-- Inline Form (Super Admin only) -->
            <div v-if="showForm && can_create" class="rounded-xl border border-sidebar-border/70 bg-white p-6 dark:border-sidebar-border dark:bg-neutral-900">
                <HeadingSmall
            ...
            <div class="rounded-xl border border-sidebar-border/70 bg-white dark:border-sidebar-border dark:bg-neutral-900">
                ...
                <!-- Pagination -->
                <div v-if="adjustments && adjustments.last_page > 1" class="flex items-center justify-center gap-2 border-t border-neutral-200 px-6 py-4 dark:border-neutral-700">
