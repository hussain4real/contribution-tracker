...
const errorConfig = computed(() => {
    ...
    > = {
        403: {
            title: 'Access Denied',
            description:
                "You don't have permission to view this page. If you believe this is a mistake, contact your family admin.",
            icon: '🔒',
            accent: 'amber',
        },
        404: {
        ...
        500: {
            ...
            description:
                "We hit an unexpected snag on our end. Our team has been notified and we're working on it.",
            icon: '⚡',
            accent: 'red',
        },
        503: {
            ...
            description:
                "We're making improvements to serve you better. Please check back in a few minutes.",
            icon: '🔧',
            accent: 'purple',
        },
    };
...
<template>
    <div>
        ...
        <div
            class="relative flex min-h-screen items-center justify-center overflow-hidden bg-linear-to-b from-slate-50 to-white dark:from-slate-950 dark:to-slate-900"
        >
            ...
            <div class="pointer-events-none absolute inset-0 overflow-hidden">
                ...
                <div
                    ...
                    style="
                        background-image: url('data:image/svg+xml,%3Csvg xmlns=%22http://www.w3.org/2000/svg%22 width=%2260%22 height=%2260%22%3E%3Cpath d=%22M60 0H0v60%22 fill=%22none%22 stroke=%22currentColor%22 stroke-width=%220.5%22/%3E%3C/svg%3E');
                    "
                />
            </div>
            ...
            <div class="relative z-10 mx-auto max-w-lg px-6 py-16 text-center">
                ...
                <Link
                    href="/"
                    class="mb-10 inline-flex items-center gap-2.5 transition-opacity hover:opacity-80"
                >
                    <div
                ...
                <div class="mb-6 flex flex-col items-center gap-3">
                    ...
                    <span
                        class="inline-flex items-center rounded-full border border-slate-200 bg-white/80 px-3 py-1 font-mono text-sm font-medium text-slate-500 backdrop-blur-sm dark:border-slate-700 dark:bg-slate-800/80 dark:text-slate-400"
                    >
                        {{ status }}
                    </span>
                </div>
                ...
                <!-- Title -->
                <h1
                    class="mb-3 text-3xl font-bold tracking-tight text-slate-900 sm:text-4xl dark:text-white"
                >
                    {{ errorConfig.title }}
                </h1>
                ...
                <!-- Description -->
                <p
                    class="mx-auto mb-10 max-w-sm text-base leading-relaxed text-slate-500 dark:text-slate-400"
                >
                ...
                <p
                    v-if="status === 404"
                    class="mt-10 text-sm text-slate-400 dark:text-slate-500"
                >
