...
import { BellRing, CheckCircle2, MessageCircle, XCircle } from '@lucide/vue';
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="mt-1 text-sm text-muted-foreground">
                                    You'll receive contribution reminders on
                    ...
                    <template v-else>
                        ...
                        >
                            <div class="grid gap-2">
                                ...
                                <p class="text-xs text-muted-foreground">
                                    ...
                                    (e.g. +234 for Nigeria). Make sure this
                        ...
                        >
                            <p class="mb-3 text-sm">
                                We sent a 6-digit code to your WhatsApp. Enter
                    ...
                    >
                        <div class="flex items-start gap-3">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="mt-1 text-sm text-muted-foreground">
                                    This browser will receive contribution
