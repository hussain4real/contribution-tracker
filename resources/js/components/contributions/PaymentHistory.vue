...
<template>
    <div
        class="rounded-lg border border-sidebar-border/70 bg-neutral-50 p-4 dark:border-sidebar-border dark:bg-neutral-800/50"
    >
        <h4
            class="mb-3 text-sm font-medium text-neutral-700 dark:text-neutral-300"
        >
            Payment History
        </h4>
