...
deployer ALL=(root) NOPASSWD: /usr/bin/find /var/www/contribution-tracker/storage /var/www/contribution-tracker/bootstrap/cache -path /var/www/contribution-tracker/storage/oauth-private.key -prune -o -type f -exec /usr/bin/chmod 0664 {} +
