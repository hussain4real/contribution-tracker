...
return [
    ...
    'google_drive' => [
        ...
        'binary' => env('BACKUP_RCLONE_BINARY', '/usr/bin/rclone'),
        'remote' => env('BACKUP_RCLONE_REMOTE', 'familyfund_drive:FamilyFund/production/backups'),
        'timeout' => env('BACKUP_RCLONE_TIMEOUT', 3600),
    ],
