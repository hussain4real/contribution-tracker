...
it('configures Pest 5 with local TIA and an unchanged full coverage gate', function () {
    ...
    expect($requirements['php'] ?? null)->toBe('^8.4')
        ...
        ->and($scripts['test:coverage:tia'] ?? null)->toContain('--parallel')
