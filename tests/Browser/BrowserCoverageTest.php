...
function browserPageRouteNames(): array
{
    return [
        ...
        'filament.platform.resources.whats-app-messages.index',
        'filament.platform.resources.whats-app-messages.view',
        'pricing',
        'privacy',
        'profile.edit',
        'register',
...
function browserCoverageAssignments(): array
{
    return [
        ...
        'family.archive.show' => ['workflow:family-retention'],
        ...
        'legacy.dashboard' => ['smoke:authenticated-family', 'workflow:pwa-launch'],
        ...
        'payment-risk.index' => ['workflow:payment-risk-insights'],
        ...
        'filament.platform.resources.whats-app-messages.index' => ['smoke:platform-admin', 'workflow:platform-navigation'],
        'filament.platform.resources.whats-app-messages.view' => ['smoke:platform-admin', 'workflow:platform-navigation'],
        'pricing' => ['smoke:guest'],
        'privacy' => ['smoke:guest'],
        'profile.edit' => ['smoke:authenticated-family'],
        'register' => ['smoke:guest'],
        'reconciliation.index' => ['workflow:reconciliation'],
...
function browserCoverageExcludedRouteName(string $routeName): bool
{
    ...
    return in_array($routeName, [
        ...
        'contributions.my-statement',
        'payment-batches.receipt',
        'reports.artifacts.show',
        'reports.deliveries.download',
        'reports.export',
